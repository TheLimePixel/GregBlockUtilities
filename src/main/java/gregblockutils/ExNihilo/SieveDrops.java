...
public class SieveDrops {
    ...
    public static void addSieveRecipe() {
        ...
        addRecipe(gravel, Materials.CassiteriteSand, 0.0432, 1);
        addRecipe(gravel, Materials.GarnetSand, 0.0432, 1);
        addRecipe(gravel, Materials.Asbestos, 0.0432, 1);
        addRecipe(gravel, Materials.Diatomite, 0.0144, 1);
        ...
        //Nether
        addRecipe(rack, Materials.Chalcopyrite, 0.0432, 1);
        addRecipe(rack, Materials.Iron, 0.0432, 1);
        addRecipe(rack, Materials.Pyrite, 0.0432, 1);
        addRecipe(rack, Materials.Copper, 0.0144, 1);
        addRecipe(rack, Materials.BrownLimonite, 0.0324, 1);
        addRecipe(rack, Materials.YellowLimonite, 0.0324, 1);
        addRecipe(rack, Materials.BandedIron, 0.0324, 1);
        addRecipe(rack, Materials.Malachite, 0.0108, 1);
        addRecipe(rack, Materials.Magnetite, 0.1428, 1);
        addRecipe(rack, Materials.Iron, 0.0357, 1);
        addRecipe(rack, Materials.VanadiumMagnetite, 0.0357, 1);
        addRecipe(rack, Materials.Gold, 0.0238, 1);
        addRecipe(rack, Materials.NetherQuartz, 0.324, 1);
        ...
        addRecipe(rack, Materials.Sulfur, 0.1632, 1);
        addRecipe(rack, Materials.Pyrite, 0.0544, 1);
        addRecipe(rack, Materials.Sphalerite, 0.0544, 1);
        addRecipe(rack, Materials.Tennantite, 0.0816, 1);
        ...
        addRecipe(end, Materials.Bentonite, 0.0192, 4);
        addRecipe(end, Materials.Magnesite, 0.0192, 4);
        addRecipe(end, Materials.Olivine, 0.0192, 4);
        addRecipe(end, Materials.Glauconite, 0.064, 4);
        addRecipe(end, Materials.Platinum, 0.0288, 4);
        addRecipe(end, Materials.Palladium, 0.0224, 4);
        addRecipe(end, Materials.Iridium, 0.0128, 4);
